...
var DashboardQueries = /** @class */ (function () {
    ...
    DashboardQueries.prototype.topFive = function () {
    ...
    DashboardQueries.prototype.category = function (product_category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [product_category])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows];
