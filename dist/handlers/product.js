        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (products.length < 1) {
                    return [2 /*return*/, res.json({ message: 'There are no products in the store' })];
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                result = _a.sent();
                if (!result) {
                    return [2 /*return*/, res.json({ message: 'No product with that id' })];
                }
                res.json({ status: 200, data: result });
                return [3 /*break*/, 4];
            case 3:
                error_2 = _a.sent();
                throw new Error("Failed to get product with id: ".concat(id));
...
var productRoutes = function (app) {
    ...
    app.post('/products', verifyToken_1.verifyToken, exports.create);
};
